...
<button class="group rounded-full p-1 hover:bg-zinc-100 dark:hover:bg-zinc-800" on:click={toggleTheme}>
	{#if theme === "light"}
		<svg
			...
			height="1em"
			viewBox="0 0 24 24"
			class="h-6 w-6 text-zinc-600 transition-colors group-hover:text-zinc-900 dark:text-zinc-400 group-hover:dark:text-zinc-100"
		>
			<g fill="none" stroke="currentColor" stroke-dasharray="2" stroke-dashoffset="2" stroke-linecap="round" stroke-width="2">
				...
				<path d="M0 0">
					...
					/>
					<animate fill="freeze" attributeName="stroke-dashoffset" begin="0.75s" dur="0.6s" values="2;0" />
				</path>
			</g>
			<g fill="currentColor">
			...
			<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				...
				/>
				<set attributeName="opacity" begin="0.3s" to="0" />
			</g>
			...
			<circle cx="12" cy="12" r="10" fill="currentColor" mask="url(#lineMdMoonToSunnyOutlineTransition0)" opacity="0">
		...
		>
			<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				...
				<path
					...
					opacity="0"
				>
					<set attributeName="opacity" begin="0.25s" to="1" />
				</path>
			</g>
			...
			<circle cx="12" cy="12" r="6" fill="currentColor" mask="url(#lineMdSunnyOutlineToMoonTransition0)">
				<set attributeName="opacity" begin="0.25s" to="0" />
